...
def easy(window, ans5, qu5, qu4, qu3, qu2, qu1):
    ...
    if instance == 1:
        question.setText('''6. Which of the following rivers
flows through the city of London?''')
    elif instance == 2:
        question.setText('''6. Which of the following mountains is
the highest in Europe?''')
    elif instance == 3:
        question.setText('''6. Which of the following cities is
