...
def easy(window, ans7, qu7, qu6, qu5, qu4, qu3, qu2, qu1):
    ...
    if instance == 1:
        question.setText('''8. Which mountain range separates Europe from Asia?''')
    elif instance == 2:
        question.setText('''8. What is the name of the peninsula that, along with the Scandinavian Peninsula,
separates the North Sea from the Baltic Sea?''')
    elif instance == 3:
        question.setText('''8. What is the capital of Belarus?''')
